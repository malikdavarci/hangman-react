...
//     return (
//       <>
//         <div style={{ width: "100px", height: "2px", background: '#000000', marginLeft:"100px"}}/>
//         <div style={{ width: "2px", height: "250px", background: '#000000', marginLeft:"126px", marginTop:"10px"}}/>
//         <div style={{ width: "250px", height: "2px", background: '#000000' }} />
//       </>
//     );
//   };
  ...
  return (
    <div className="HangmanGame">
      ...
      <div className="IncorrectAttempts">
        <p>Yanlış Denemeler: {incorrectAttempts}/8</p>
      </div>
